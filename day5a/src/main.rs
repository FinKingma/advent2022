...
fn main() {
    ...
    for line in lines {
        ...
        if header {
            ...
            let slice_reverse = &slice.chars().rev().collect::<String>();
            ...
            array[(push-1) as usize] = slice_reverse.to_owned() + &new_old_val;
            println!("move {} from {} to {}: take {} size {} slicerev {} remainder {}", amount, pull, push, old_val, length, slice_reverse, remainder);
            println!("step {:?}", array);
        }
    }
